...
class GNNBase(LightningModule):
    ...
    def handle_directed(self, batch):
        ...
        score_sample = batch.edge_attr.repeat(2).unsqueeze(-1)
        ...
        return edge_sample, score_sample
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        input_edges, input_scores = self.handle_directed(batch)
        x, generated_scores = self(input_data, num_nodes, input_edges, batch.batch)
        ...
        if optimizer_idx == 1:
            ...
            real_loss = self.adversarial_loss(self.discriminator(input_data, input_edges, input_scores, batch.batch), truth)
    ...
    def shared_evaluation(self, batch, batch_idx, log=True):
        ...
        real_predictions = self.discriminator(input_data, input_edges, input_scores, batch.batch)
        ...
        edge_predictions, edge_acc, edge_auc = self.get_metrics(input_scores, generated_scores)
