...
class GNNBase(LightningModule):
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        input_edges, _ = self.handle_directed(batch)
    ...
    def shared_evaluation(self, batch, batch_idx, log=True):
        ...
        if log:
            ...
            self.log_dict(
                {"generator_val_loss": g_loss, "discriminator_val_loss": d_loss, "current_g_lr": current_g_lr, "current_d_lr": current_d_lr, "disc_acc": disc_acc}, sync_dist=True
            )
